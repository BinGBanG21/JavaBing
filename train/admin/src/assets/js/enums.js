...
SEAT_TYPE_ARRAY = [{code: "1", desc: "一等座"}, {code: "2", desc: "二等座"}, {code: "3", desc: "软卧"}, {
    code: "4",
    desc: "硬卧"
}];
SEAT_COL_ARRAY = [{code: "A", desc: "A"}, {code: "C", desc: "C"}, {code: "D", desc: "D"}, {
    code: "F",
    desc: "F"
}, {code: "A", desc: "A"}, {code: "B", desc: "B"}, {code: "C", desc: "C"}, {code: "D", desc: "D"}, {
    code: "F",
    desc: "F"
}];